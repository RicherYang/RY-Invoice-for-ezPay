...
final class RY_IFEZPAY_WC_Invoice
{
    ...
    protected function do_init(): void
    {
        ...
        if (is_admin()) {
            include_once RY_IFEZPAY_PLUGIN_DIR . 'woocommerce/admin/admin.php';
            RY_IFEZPAY_WC_Admin::instance();

            include_once RY_IFEZPAY_PLUGIN_DIR . 'woocommerce/admin/invoice.php';
            RY_IFEZPAY_WC_Admin_Invoice::instance();
        } else {
