...
final class RY_IFEZPAY_WC_Admin_Invoice
{
    ...
    {
        include_once RY_IFEZPAY_PLUGIN_DIR . 'woocommerce/admin/meta-boxes/class-wc-meta-box-invoice-data.php';
        add_action('woocommerce_admin_order_data_after_billing_address', ['RY_IFEZPAY_MetaBox_Invoice_Data', 'output']);

        include_once RY_IFEZPAY_PLUGIN_DIR . 'woocommerce/admin/settings/invoice.php';
        RY_IFEZPAY_WC_Admin_Setting_Invoice::instance();
