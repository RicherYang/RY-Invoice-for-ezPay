        ...
        if ($matches) {
            ...
            if (2 === count($message_info)) {
                ...
                try {
                    ...
                    $log_text .= '<details><summary style="cursor:pointer;">' . __('Details', 'ry-invoice-for-ezpay') . '</summary>'
...
<a href="<?php echo esc_url(Utils::the_action_link('general-logs', 'dl-log', [
    'group' => $current_group,
    'log' => $current_log,
])); ?>" class="button"><?php esc_html_e('Download', 'ry-invoice-for-ezpay'); ?></a>
&emsp;
<a href="<?php echo esc_url(Utils::the_action_link('general-logs', 'delete-log', [
    'group' => $current_group,
    'log' => $current_log,
])); ?>" class="button"><?php esc_html_e('Delete Permanently', 'ry-invoice-for-ezpay'); ?></a>
&emsp;
<?php echo esc_html(sprintf(
    /* translators: %d: Number of days */
    __('Log file will delete after %d days', 'ry-invoice-for-ezpay'),
