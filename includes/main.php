...
include_once RY_IFEZPAY_PLUGIN_DIR . 'includes/ry-general/abstract-basic.php';

final class RY_IFEZPAY extends RY_Abstract_Basic
{
    ...
    public function do_wp_init(): void
    {
        ...
        if (is_admin()) {
            ...
            include_once RY_IFEZPAY_PLUGIN_DIR . 'includes/ry-general/admin-logs.php';
